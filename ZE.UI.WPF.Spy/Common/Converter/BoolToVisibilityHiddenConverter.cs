//----------------------------------------------------------------------------------------------------
// <copyright file="BoolToVisibilityHiddenConverter.cs" company="Zühlke Engineering AG">
...
namespace ZE.UI.WPF.Spy.Common.Converter
{
  /// <summary>
  /// Value converter converting a boolean to a <see cref="Visibility"/>. True converts to Visibility.Visible, false to Visibility.Hidden.
  /// If the parameter is true (bool or string), the converter inverts the result.
  /// </summary>
  public class BoolToVisibilityHiddenConverter : ValueConverterMarkupExtensionBase, IValueConverter
  {
